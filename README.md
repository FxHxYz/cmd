...
> __?nt <фраза> <время> - masstimeout | мьютит 100 старых + новые сообщения (пока что не работает) __

> __?nb <фраза> - massban | банит 100 старых + новые сообщения (пока что не работает) __
