...
> __?num - бот удаляет сообщение состоящие из 2 или более цифр _(пока что не работает)_ __
...
> __?nt <фраза> <время> - masstimeout | мьютит 100 старых + новые сообщения _(пока что не работает)_ __

> __?nb <фраза> - massban | банит 100 старых + новые сообщения _(пока что не работает)_ __
